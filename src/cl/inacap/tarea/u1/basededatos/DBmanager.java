...
public class DBmanager {
	 ...
	 // columna tabla relacion
	   ...
	   public static String CREATE_TABLE3 ="CREATE TABLE "+ DATABASE_TABLA3 +"( "+
		   		...
		   		FECHA + " TEXT , " +
		   		PRECIO + " INTEGER , " +
		   		ESTADO + " TEXT ,  FOREIGN KEY("+ID_CLIENTE+") references "+DATABASE_TABLA2+");";
	  ...
	  */
		   try{
		    db.execSQL("insert into "+ DATABASE_TABLA1 +" values('juan','juan','juan')");
		   	...
		   	db.execSQL("insert into "+ DATABASE_TABLA3 +" values('11000999-8','454','Vino','4','14/7/2015','450','NO ENTREGADO')");
			db.execSQL("insert into "+ DATABASE_TABLA3 +" values('11000999-8','454','Ron','3','14/7/2015','100','NO ENTREGADO')");
			db.execSQL("insert into "+ DATABASE_TABLA3 +" values('11000999-8','454','Pan','1','14/7/2015','700','PRODUCTO ENTREGADO')");
			db.execSQL("insert into "+ DATABASE_TABLA3 +" values('10000999-9','300','Ron','3','14/7/2015','100','NO ENTREGADO')");
			db.execSQL("insert into "+ DATABASE_TABLA3 +" values('10000999-9','300','Coca Cola','1','14/7/2015','700','PRODUCTO ENTREGADO')");
			db.execSQL("insert into "+ DATABASE_TABLA3 +" values('10000999-9','4000','Ron','3','14/7/2015','100','NO ENTREGADO')");
			db.execSQL("insert into "+ DATABASE_TABLA3 +" values('10000999-9','4000','Pan','1','14/7/2015','700','NO ENTREGADO')");
	...
	// funcion que datos gqs
	   ...
	   // funcion eliminar cliente
		 ...
		 * */
		public void insertar_relacion2( String rut_cliente,
				String num_compra1, String producto1, Integer cantidad1,
				String fecha1, Integer precio1) {
			
		   	db.execSQL("insert into "+ DATABASE_TABLA3 +" values('"+rut_cliente+"','"+num_compra1 +"','"+ producto1 +"',"+ cantidad1 +",'" + fecha1 + "',"+ precio1+",'NO ENTREGADO')");
		...
		public List<String> obtener_boleta(String cliente) {
			List<String> lista = new ArrayList<String>();
		...
		public void entregar_producto( String id_cliente,
				String num_boleta, String producto_seleccionado,
				String estado) {
			
			
			db.execSQL("update "+ DATABASE_TABLA3 +" set " + ESTADO + " = '" + estado +  "' where id_cliente = '" + id_cliente + "' and producto = '" + producto_seleccionado + "' and num_compra = '" + num_boleta + "' ");

			
			
		}

		public List<String> cargar_all_compras_cliente(
				String id_cliente) {
			
			List<String> lista = new ArrayList<String>();
		    Cursor cursor = db.rawQuery("SELECT DISTINCT " + NUM_COMPRA + " FROM " + DATABASE_TABLA3 + " where id_cliente = '" + id_cliente + "'", null);
		...
		public List<String> mostrar_productos_entregados(
				String id_cliente2, String obtener_compra) {
			
					List<String> lista = new ArrayList<String>();
				    Cursor cursor = db.rawQuery("SELECT DISTINCT " + PRODUCTO + " FROM " + DATABASE_TABLA3 + " where id_cliente = '" + id_cliente2 + "' and num_compra = '" + obtener_compra + "' and estado = 'PRODUCTO ENTREGADO'", null);
		...
		public List<String> mostrar_productos_no_entregados(
				String id_cliente2, String obtener_compra) {
			
			List<String> lista = new ArrayList<String>();
		    Cursor cursor = db.rawQuery("SELECT DISTINCT " + PRODUCTO + " FROM " + DATABASE_TABLA3 + " where id_cliente = '" + id_cliente2 + "' and num_compra = '" + obtener_compra + "' and estado = 'NO ENTREGADO'", null);
		...
		public String total_pedidos_x_cliente( String id_cliente2) {
			
		    Cursor cursor = db.rawQuery("SELECT  (" + PRODUCTO + ") FROM " + DATABASE_TABLA3 + " where id_cliente = '" + id_cliente2 + "'", null);
		...
		public String total_pedidos_no_entregados(
				String id_cliente2) {
		    Cursor cursor = db.rawQuery("SELECT  (" + PRODUCTO + ") FROM " + DATABASE_TABLA3 + " where id_cliente = '" + id_cliente2 + "' and estado = 'NO ENTREGADO'", null);
	...
	public String total_precio(String id_cliente2,String boleta) {
			
		    Cursor c = db.rawQuery("SELECT  SUM (" + PRECIO + ") FROM " + DATABASE_TABLA3 + " where id_cliente = '"+id_cliente2+"' and num_compra = '"+ boleta +"'", null);

		    if(c !=null){
				c.moveToFirst();
				String tot2 =c.getString(0);
				c.close();
				db.close();
			 	return(tot2);
		}
		...
		public String total_fecha(String id_cliente2,String boleta) {
		    Cursor c = db.rawQuery("SELECT  (" + FECHA + ") FROM " + DATABASE_TABLA3 + " where id_cliente = '"+id_cliente2+"' and num_compra = '"+boleta+"'", null);
